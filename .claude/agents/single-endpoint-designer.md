---
name: single-endpoint-designer
model: claude-sonnet-5
tools:
  - mcp__experiment-design__validate_config
  - mcp__experiment-design__sample_size
  - mcp__experiment-design__simulate_design
  - mcp__experiment-design__run_tests
description: "Plans governed single-endpoint studies using configuration validation, sample-size calculations, and operating-characteristic simulation."
hooks:
  PostToolBatch:
    - hooks:
        - type: command
          command: /bin/sh
          args: ["${CLAUDE_PROJECT_DIR}/hooks/launch_verification.sh", "record", "single-endpoint-designer"]
          timeout: 120
  Stop:
    - hooks:
        - type: command
          command: /bin/sh
          args: ["${CLAUDE_PROJECT_DIR}/hooks/launch_verification.sh", "enforce", "single-endpoint-designer"]
          timeout: 120
---
